...
[Аудит алгоритмов, исследований и документации b1ee2711…HEAD (2026-09-22)](Audit/TimeLearner-2026-09-22/README.md)
...
- [Docs.old/] (исторический путь `../Docs.old/`; файл/каталог отсутствует в текущем checkout) - устаревшие `.doc` и Doxygen-артефакты (не поддерживаются)
