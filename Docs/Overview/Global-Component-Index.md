# Global Component Index (Libraries/*)

Сводные ссылки на каталоги компонентов по каждой библиотеке (регистрация в `UStorage`). Навигация: эти ссылки работают в корневом репозитории GitHub; внутри сабрепозитория используйте локальные `Docs/Component-Catalog.md`.
