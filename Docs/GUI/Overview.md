...
- **Редактор диаграмм** - визуальное создание и редактирование сетей компонентов; Coord layout и ортогональная маршрутизация связей — [ModernDiagram-Coord-Routing.md](ModernDiagram-Coord-Routing.md)
