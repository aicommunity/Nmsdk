...
#ifndef TNewManipulatorControlFormH
#define TNewManipulatorControlFormH
//---------------------------------------------------------------------------
...
__published:	// IDE-managed Components
	...
	TTrackBar *NumMotionElementsTrackBar;
	TLabel *Label14;
	TEdit *NumMotionElementsEdit;
	...
	TCheckBox *BranchModeCheckBox;
	TCheckBox *RenshowCellsCheckBox;
	TCheckBox *UseSimpleAfferentsCheckBox;
	TCheckBox *UseNewNeuronsCheckBox;
	TLabeledEdit *CurrentContourAmplitudeLabeledEdit;
	TLabeledEdit *CurrentContourAverageLabeledEdit;
	TLabeledEdit *TransientTimeLabeledEdit;
	TCheckBox *CurrentTransientStateCheckBox;
	...
	void __fastcall NumMotionElementsTrackBarChange(TObject *Sender);
	void __fastcall IINumAfferentTrackBarChange(TObject *Sender);
	void __fastcall BranchModeCheckBoxClick(TObject *Sender);
	void __fastcall RenshowCellsCheckBoxClick(TObject *Sender);
...
//---------------------------------------------------------------------------
extern PACKAGE TNewManipulatorControlForm *NewManipulatorControlForm;
//---------------------------------------------------------------------------
#endif
