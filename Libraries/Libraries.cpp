...
/// ‘ункци€ должна быть реализована в конечном проекте и загружать требуемые библиотеки
...
/// ‘ункци€ должна быть реализована в конечном проекте
/// и загружать функции формировани€ свойств дл€ фиктивных компонентов из библиотек
