...
int main() {
    ...
    try {
        ...
        std::cout << "2. Creating Environment variable..." << std::endl;
        ...
        std::cout << "3. Setting Storage to Environment..." << std::endl;
        ...
        std::cout << "4. Getting Storage from Environment..." << std::endl;
        ...
        std::cout << "5. Testing TakeObject with UModel..." << std::endl;
        ...
        std::cout << "6. Testing other object types..." << std::endl;
