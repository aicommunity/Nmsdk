...
void AddWatch(TWatchFrame *watch, RDK::UAContainer *item, int output, int outindex, real watchinterval, real yshift=0, TPenStyle style=psSolid, TColor color=TColor(0));
...
void AddFrequencyWatch(TWatchFrame *watch, RDK::UAContainer* item, real watchinterval, real yshift=0, TPenStyle style=psSolid, TColor color=TColor(0));
